...
export const getArticleById = async (id) => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to fetch blog details');
  }
};
...
export const createArticle = async (formData) => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to create blog');
  }
};
...
export const updateArticle = async (id, formData) => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to update blog');
  }
};
